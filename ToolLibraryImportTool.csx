...
public class LibWrap
{
    ...
    public static extern bool GetOpenFileName([In, Out] OpenFileName ofn);
     ...
     //instantiate the open file dialog class
            ...
            ofn.title = "Select a .stp file to import as tool";
            //starting directory
			...
			{
			     var tool = new Cnc.Tool.Interop.TlToolMill
                {﻿
                    Name = "peters tool with geometry",
            ...
            try
            {
			  ...
			  // import the actual file
                success = Cnc.Tool.Interop.TlGeometryImportExport.ImportProfileFromFile(tool, stlFilePath,false,false);
                if (!success)
                {
